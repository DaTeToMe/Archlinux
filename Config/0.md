...
```
sudo pacman -S gedit rofi thunar gvfs-smb ranger google-chrome evince mplayer networkmanager alsa-utils
```
# 增加软件仓库
```
...
# 安装Wechat QQ TIM
```
yaourt -S freshplayerplugin deepin.com.wechat deepin.com.qq.im deepin.com.qq.office
```
# 安装wps  (libreoffice)
```
